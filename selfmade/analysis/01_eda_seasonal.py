...
# STL: period=30 (월간 시즌성) — 빼빼로데이·설날 등 연간 이벤트 포착에 적합
# Reviewer 권고: period=7(주간)은 연간 시즌 이벤트를 과소포착함
stl = STL(daily_gmv["total_amount_krw"], period=30, robust=True)
stl_result = stl.fit()

print("\n--- STL Decomposition 완료 (period=30) ---")
...
plt.suptitle("STL Decomposition — 일별 GMV (period=30, 월간 시즌성)", fontsize=13, fontweight='bold', y=1.01)
plt.tight_layout()
